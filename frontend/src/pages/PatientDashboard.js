...
import { FiUser, FiFileText, FiCalendar, FiUsers, FiSettings, FiLogOut, FiMenu, FiX, FiEdit } from 'react-icons/fi';
...
const PatientDashboard = () => {
  ...
  const menuItems = [
    ...
    { id: 'doctors', label: 'Find Doctors', icon: FiUsers },
            ...
            {editMode ? (
              ...
              <div className="profile-cards">
                <div className="info-card">
                  ...
                  <button className="edit-btn" onClick={() => setEditMode(true)}><FiEdit /> Edit</button>
                </div>
                <div className="info-card">
        ...
        return (
          <div className="content-section">
            ...
            <div className="empty-state">
              ...
              <button className="action-btn" onClick={() => navigate('/medical-records')}>View Records</button>
            </div>
          </div>
        );
      case 'appointments':
        return (
          <div className="content-section">
            ...
            <div className="empty-state">
              ...
              <button className="action-btn" onClick={() => navigate('/book-appointment')}>Book Appointment</button>
            </div>
          </div>
        );
      case 'doctors':
        return (
          <div className="content-section">
            ...
            <div className="empty-state">
              ...
              <button className="action-btn" onClick={() => navigate('/find-doctors')}>Find Doctors</button>
            </div>
          </div>
        );
      default:
        return (
          <div className="content-section">
            ...
            <div className="dashboard-grid">
              ...
              <div className="dashboard-card" onClick={() => setActiveSection('records')}>
              ...
              <div className="dashboard-card" onClick={() => setActiveSection('doctors')}>
